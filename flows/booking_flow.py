...
# These classes are needed for the function tools in this module.
...
# --- Helper Function ---
def capture_user_info(latest_user_message: str, booking_context: dict, previous_filters: dict, candidate_clinics: list, factual_brain_model):
    try:
        extraction_prompt = f"""
