...
# <<< UPGRADE #1: The AI Planner can now correctly handle a LIST of services >>>
...
def handle_chat(query: UserQuery):
    ...
    # <<< UPGRADE #2: The Comprehensive Fallback Logic >>>
    if len(all_candidates) < 3 and active_filters:
        ...
        key_filters_to_try = ['services', 'min_pain_management', 'min_dentist_skill', 'min_staff_service']
